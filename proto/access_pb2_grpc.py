...
class AccessServicer(object):
    ...
    def SubmitSuccessfulAccess(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def SubmitFailedAccess(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_AccessServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'Access', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Access', rpc_method_handlers)
...
class Access(object):
    ...
    @staticmethod
    def SubmitSuccessfulAccess(request,
            target,
            options=(),
    ...
    @staticmethod
    def SubmitFailedAccess(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
